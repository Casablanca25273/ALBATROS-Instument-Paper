...
% In the overplotted mean spectra, the baseband data are shown with
% finer, 14.6-kHz resolution to illustrate the additional information
% that is not available in the accumulated spectra.  For these mean
% spectrum plots, the baseband data are processed by
