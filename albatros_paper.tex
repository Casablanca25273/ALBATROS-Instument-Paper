...
Comprehensive reviews exist elsewhere (\attention{find a good
...
\attention{More text about the science case, including
...
The SNAP board sends its output data via ethernet to a Raspberry Pi (\attention{version? citation?}), which saves it to a hard drive.

\iffalse

\attention{finish merging text
...
\attention{include text about firmware}
