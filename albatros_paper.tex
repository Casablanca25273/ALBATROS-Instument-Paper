...
exploring alternative antenna designs that will that will cover the
...
\begin{figure}
  \begin{center}
    ...
    \caption{Spectra from a co-aligned polarization pair from the
      ...
      are in uncalibrated ADC units on a logarithmic scale.
      Repeatable structure from the Galaxy is visible over the
      three-day time scale in all plots.}
...
fringes are visible in the phases of the cross-spectra.  The RFI lines
at $\lesssim20$~MHz arise primarily from shortwave radio transmission
...
even visible a little below $\sim10$~MHz, demonstrates the proof of
