...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{\attention{Placeholder figure} Autospectra for one
      ...
      autospectra, with finer, 14.6-kHz resolution of
...
spectra computed by the SNAP board.  In the overplotted mean spectra,
the baseband data are shown with finer, 14.6-kHz resolution to
illustrate the additional information that is not available in the
accumulated spectra.  For these mean spectrum plots, the baseband data
are processed by
